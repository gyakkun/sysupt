...
?>
    ...
    src = "js/highchart.exporting.js" / ></script>
    ...
    <table class="main" width="940" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="embedded">
                <h1 align="center" class="pagetitle">SYSPT :: 历史数据统计</h1>
                <form id="filter_form" method="post">
                    <table>
                        <tr>
                            <td>
                                起始时间: <br/><input type="text" name="start_date" class="datepicker"
                                                  value="<?php echo date('m/d/Y', time() - 31 * 86400); ?>"/>
                            </td>
                            <td>
                                结束时间: <br/><input type="text" name="end_date" class="datepicker"
