...
(4, '江湖朝堂', 'Peasant', 'User', 'Power User', 'Elite User', 'Crazy User', 'Insane User', 'Veteran User', 'Extreme User', 'Ultimate User', 'Nexus Master', 'VIP', 'Retiree', 'Uploader', 'Moderator', 'Administrator', 'SysOp', 'Staff Leader'),
