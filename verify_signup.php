...
if ($id && $action) {
    ...
    if ($action == 'accept') {
        ...
        $message = "你的账户申请已被驳回，原因为「{$reason}」。请勿重新申请/注册，如有问题请加入<a href='//shang.qq.com/wpa/qunwpa?idkey=c584748ff16ae67f8f381f0d4e5f87132551ad01704b90075d90da4f4e659ee4'>SYSPT临时群：637597613</a>申诉。<br>----------------<br>" . $SITENAME . "管理组";
    }
