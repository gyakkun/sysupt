...
if ($dict['created by'] == "hdchina.org") {
    ...
    $dict['comment'] = "Torrent From SYSPT";
}
...
/* Shut up!
if ($tjuptrip == 'yes') {
    $pre_to_shoutbox ['text'] = "SYSPT小组作品[b][color=red]" . $nameset . "[/color][/b]发布啦：[url=details.php?id=" . mysql_real_escape_string($id) . "&hit=1]大家这里使劲戳[/url]";
