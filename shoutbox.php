...
if (mysql_num_rows ( $res ) == 0)
    ...
    print ("<font size=3 color=#FF0000><b>请勿刷屏、求资源、发广告，严禁粗口</b>(<a class='faqlink' href='/forums.php?action=viewtopic&forumid=32&topicid=13' target='_blank'>新手手册</a>,&nbsp;<a class='faqlink' href='faq.php' target='_blank'>常见问题</a>,&nbsp;<a class='faqlink' href='rules.php' target='_blank'>本站规则</a>)</font>&nbsp;&nbsp;&nbsp;&nbsp;<font size=3 color=#0000FF><b>如有问题欢迎加入 SYSPT用户交流 QQ群咨询：1009541180</b></font><br>");
