...
if ($arr['state'] != 2) {
    stderr($lang_jc_confirm['wrong_head'], $lang_jc_confirm['finished'] . $lang_jc_confirm['click'] . "<a class=altlink href=\"jc_currentbet_L.php\">" . $lang_jc_confirm['here'] . "</a>" . $lang_jc_confirm['back1'], false);
}
