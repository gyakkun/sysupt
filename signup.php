    ...
    <p>
        ...
        <form name="formUser" onSubmit="return register();" method="post" action="takesignup.php">
            ...
            <table border="1" cellspacing="0" cellpadding="10">
                ...
                <tr>
                    ...
                    <td class=rowfollow align=left><input type="text" style="width: 200px"
                        ...
                        <table width=250 border=0 cellspacing=0 cellpadding=0>
                            ...
                            </font></br>不推荐用edu邮箱，因为这可能不是你的常用邮箱，忘记邮箱密码会导致无法通过邮件找回SYSUPT账号的密码。</br>
                ...
                //School select
                if ($showschool == 'yes') {
                    $schools = "<option value=2>---- " . $lang_signup['select_none_selected'] . " ----</option>n";
                    ...
                    while ($sc_a = mysql_fetch_array($sc_r))
                        $schools .= "<option value=$sc_a[id]" . ($sc_a['id'] == 2 ? " selected" : "") . ">$sc_a[name]</option>n";
