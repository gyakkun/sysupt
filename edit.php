...
if (!isset ($CURUSER) || ($CURUSER ["id"] != $row ["owner"] && get_user_class() < $torrentmanage_class)) {
    ...
    print ("<tr><td class=\"rowhead nowrap\" valign=\"top\" align=\"right\"><input name=\"reasontype\" type=\"radio\" value=\"5\" />&nbsp;合集</td><td class=\"rowfollow\" valign=\"top\" align=\"left\"> 合集已出，删除单集和小合集，感谢您对SYSPT的贡献。</td></tr>");
