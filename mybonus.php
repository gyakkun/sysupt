...
loggedinorreturn();
parked();
global $uploadtorrent_bonus, $uploadsubtitle_bonus, $starttopic_bonus, $starttopic_bonus, $makepost_bonus, $tzero_bonus,
       $addcomment_bonus, $pollvote_bonus, $offervote_bonus, $funboxvote_bonus, $ratetorrent_bonus, $saythanks_bonus,
...
if (!$action) {
    ...
    for ($i = 1, $j = 0; $i < 20; $i++) {
        ...
        if ($i == 5) { // for Custom Title!
            ...
            print ("<td class=\"rowfollow\" align=\"center\"><input type=button value=\"" . ($CURUSER ["class"] < UC_USER ? "User" . $lang_mybonus ['text_plus_only'] . "\" disabled" : ($CURUSER ['seedbonus'] < 1000 ? $lang_mybonus ['text_more_points_needed'] . "\" disabled" : "我要玩\" onclick=\"location.href='blackjack.php'\"")) . "/></td>");
            continue;
    ...
    <table width="940" cellpadding="3">
        <tr>
            <td class="colhead" align="center"><font
                        class="big"><?php echo $lang_mybonus['text_what_is_karma'] ?></font></td>
        </tr>
        <tr>
