...
loggedinorreturn();
parked();
global $bonus_tweak, $CURUSER, $SITENAME;
...
if ($action == "default") {
    ...
    <tr>
        <td class="text" align="center"
            colspan="4"><?php echo $lang_mybonusapps['text_exchange_your_karma'] ?><?php echo $bonus ?><?php echo $lang_mybonusapps['text_for_goodies'] ?>
